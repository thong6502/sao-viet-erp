const REALTIME_MODULES = new Set([
  ...
  "xep_lich_2", "xep_lich_3", "kho", "tang_ca", "cham_cong", "thu_mua", "yeu_cau_mua_hang", "ke_toan",
...
export function coTheMoKenhSse(readable: ReadonlySet<string>): boolean {
  return coQuyenBanTo(readable) || [...readable].some((moduleKey) => REALTIME_MODULES.has(moduleKey));
}
