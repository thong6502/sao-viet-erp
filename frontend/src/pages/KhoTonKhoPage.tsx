    ...
    <main className="rc kho-list">
      ...
      {openMaterial && (
        ...
        <MaterialHistoryDrawer
          ...
          threshold={thresholds[openMaterial.material_id]}
          canViewCost={canViewCost}
      ...
      {nguongFor && (
        ...
        <SetThresholdDialog
          key={`ng-${nguongFor.material_id}`}
          token={token}
          khoId={khoId}
          material={nguongFor}
          current={thresholds[nguongFor.material_id]}
          onSaved={(t) =>
            setThresholds((prev) => ({ ...prev, [nguongFor.material_id]: t }))
          }
