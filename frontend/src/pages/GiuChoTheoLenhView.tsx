 ...
 *  tông; các trạng thái trung tính (đã cấp / đã giữ / chưa rõ) giữ token đất cho chìm, chỉ tin xấu
 *  mới tươi — `co_the_giu` nằm phía tin xấu (`--kh-canhbao-fg`) vì nó là việc CHƯA làm. */
