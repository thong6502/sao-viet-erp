...
def render_pdf(
    ...
    for i, node in enumerate(nodes, start=1):
        ...
        # là biết "bước này ai làm, lấy dao ở đâu". Dao chưa về thì nói THẲNG — im lặng ở đây là để
        # thợ đi tìm một con dao không có trong kho. Không còn ngày dự kiến (mg `0293` gỡ cột).
