...
def list_items(
    svc: Service,
    # Danh mục THAM CHIẾU: đọc được nếu có quyền cấu hình danh mục HOẶC quyền Tính giá
    # (màn Tính giá cần đổ dropdown Loại SP mà không phải mở màn cấu hình danh mục).
