...
**Vì sao là bảng nối chứ không phải cột trên máy hay trên công đoạn:** cả hai con số đều là giao của VIỆC × MÁY. `cong_thuc_gio` treo ở máy (`may_thiet_bi.cong_thuc_luong`, gỡ ở mg `0273`) thì mọi công đoạn chạy máy đó dùng chung một cách đo — trong khi cùng một máy in, công đoạn khổ 79×109 và khổ 11×11 đo khác nhau. `cong_thuc_gia` treo ở công đoạn (`cong_doan.cong_thuc_gia`) thì mọi máy dùng chung một đơn giá — trong khi máy 5 màu khổ lớn và máy 2 màu khổ nhỏ có giá khác nhau.
